...
def main():
 with tempfile.TemporaryDirectory() as td:
  ...
  cases.append((R,record(),0,'valid schema 1.1 record'))
  ...
  x=record();x['protocol_interventions']['total']=1.5;cases.append((R,x,1,'noninteger intervention total'))
  x=record();x['protocol_interventions']['breakdown']['evidence_gap']=-1;cases.append((R,x,1,'negative intervention category'))
  x=record();x['protocol_interventions']['breakdown']['other']=1;x['protocol_interventions']['total']=1;cases.append((R,x,1,'unknown intervention category'))
  x=record();x['protocol_interventions']['total']=1;cases.append((R,x,1,'intervention total mismatch'))
